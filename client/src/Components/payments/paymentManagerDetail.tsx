...
import { setCloseDetails } from "../../redux/slice/paymentSlice"
...
export const PaymentManagerDetails = () => {
    const dispatch = useAppDispatch()
    const { showDetails, titleDetails, imageUrlDetails } = useSelector((state: RootState) => state.paymentReducer)
            ...
            >
                <Box sx={style}>
                    ...
                    <Link style={{ textDecoration: 'none', color: 'inherit' }} to='/payment' >
                        <Button onClick={() => dispatch(setCloseDetails())} sx={{ ...stylesBtn }}>Back to payment management </Button>
                    </Link>
                </Box>
            </Modal>
        </>
